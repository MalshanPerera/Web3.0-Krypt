...
const Welcome = () => {
  ...
  const handleSubmit = (e: React.MouseEvent<HTMLButtonElement, MouseEvent>) => {
    ...
    // Once you submit a form the page reloads, use this to stop the reload
    e.preventDefault();
        ...
        <div className='flex flex-1 justify-start flex-col mf:mr-10'>
          ...
          <div
            className={`grid sm:grid-cols-3 grid-cols-2 w-full ${
              !currentAccount ? 'mt-5' : 'mt-10'
            } `}
          >
            <div className={`rounded-tl-2xl ${commonStyles}`}>Reliability</div>
            <div className={`rounded-tr-2xl sm:rounded-[0px] ${commonStyles}`}>
              Security
            </div>
            <div className={`sm:rounded-tr-2xl ${commonStyles}`}>Ethereum</div>
            <div className={`sm:rounded-bl-2xl ${commonStyles}`}>Web 3.0</div>
            <div className={`rounded-bl-2xl sm:rounded-[0px] ${commonStyles}`}>
              Low Fees
            </div>
